...
**Blockchain Engineer | Smart Contracts, Off-chain Systems & ZK Apps**

#### 🔹 [solidity-evm-internals](https://github.com/0xyuakira/solidity-evm-internals)
PoC-driven Solidity-to-EVM internals lab for verifying low-level semantics and deriving insights for contract design, gas reasoning, and security analysis.
